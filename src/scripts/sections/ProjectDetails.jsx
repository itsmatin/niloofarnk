  ...
  return (
    <>
      <div className="project__details">
        ...
        <Image containerClass="project__details--image" main="/map.jpg" />
      </div>
      <div className="project__details" style={{ alignItems: "center" }}>
        <Image containerClass="project__details--image" main="/map2.jpg" />
      ...
      <svg className="project__details__drawing" width="830" height="800">
        <motion.path
